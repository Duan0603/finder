...
-- ==============================================================================
-- PHẦN 2: BẢNG NHÓM HỌC TẬP & SỞ THÍCH (GROUPS)
-- ==============================================================================
...
CREATE TABLE public.groups (
    ...
    name TEXT NOT NULL,
    description TEXT,
    category TEXT NOT NULL CHECK (category IN ('Exam Prep', 'Language', 'Project', 'Coding', 'Arts', 'Sports', 'Hobbies', 'Other')),
    subject TEXT, -- Mã môn học (vd: SSA101)
    avatar_url TEXT,
...
-- RLS: Đọc công khai (hoặc cho user đăng nhập), Tự tạo tự sửa
...
-- Khi tạo group, tự động thêm người tạo vào làm admin
...
-- 2.4 Bảng group_events (Hẹn offline)
...
-- Broadcast real-time cho group_messages
